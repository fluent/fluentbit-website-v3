...
version: v1.5.6
title: Fluent Bit v1.5.6 - Release Notes
intro: Release Notes
---
...
### List of general changes
 ...
 - Core
   - upstream: remove unnecessary errno message, this fix the noisy error introduced in v1.5.5.
   - upstream: fix deletion of pending connections in the destroy_queue.
